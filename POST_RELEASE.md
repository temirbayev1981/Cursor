...
Current release tag: **`v1.10.17`**

```bash
git tag -a v1.10.17 -m "HandymanOS AI 1.10.17"
git push origin v1.10.17
```

Rollback: `git checkout v1.10.17` or reset `main` to a prior tag (team policy).
