...
Current release tag: **`v1.10.16`**

```bash
git tag -a v1.10.16 -m "HandymanOS AI 1.10.16"
git push origin v1.10.16
```

Rollback: `git checkout v1.10.16` or reset `main` to a prior tag (team policy).
