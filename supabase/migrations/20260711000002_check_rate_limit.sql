-- Rate limiting RPC for Edge Functions (required by supabase-smoke + _shared/rate-limit.ts)
-- Idempotent — safe to re-run on projects that already have schema.sql applied.
