export const ru = {
  ...
  auth: {
    ...
    accountIncomplete: 'Аккаунт не настроен. Попробуйте войти снова.',
    profileMissing: 'Профиль не найден. Обратитесь в поддержку.',
    companyMissing: 'Компания не найдена. Попробуйте войти снова.',
    registrationPending: 'Регистрация прошла. Подтвердите email при необходимости и войдите.',
    email: 'Email',
    password: 'Пароль',
    signInBtn: 'Войти',
  ...
  vendorPO: {
    ...
    poNumberMissing: 'Не удалось извлечь номер наряда из PDF',
    duplicate: 'Наряд {poNumber} уже загружен',
    duplicateInBatch: 'Наряд {poNumber} повторяется в выбранных файлах',
    duplicateFile: 'Файл {fileName} уже загружен',
    duplicateFileInBatch: 'Файл {fileName} повторяется в выбранных файлах',
    duplicateFileContent: 'Этот PDF уже загружен (тот же файл)',
    duplicatesSkipped: 'Пропущены дубликаты: {count}',
  ...
  scheduling: {
    ...
    emailSkipped: 'Заказ запланирован (email отключён: {email})',
    smsSent: 'SMS отправлено: {phone}',
    smsQueued: 'SMS в локальной очереди → {phone}',
    smsSkipped: 'Заказ запланирован (SMS отключён: {phone})',
  ...
  dispatch: {
    ...
    customerEmailSkipped: 'Заказ запланирован (email отключён: {email})',
    customerEtaSent: 'ETA отправлено: {email}',
    customerEtaQueued: 'ETA в очереди → {email}',
    customerEtaSkipped: 'ETA пропущено (email отключён: {email})',
    customerSmsSent: 'SMS клиенту: {phone}',
    customerSmsQueued: 'SMS клиенту в очереди → {phone}',
    customerSmsSkipped: 'SMS пропущено (opt-out: {phone})',
    customerEtaSmsSent: 'ETA SMS: {phone}',
    customerEtaSmsQueued: 'ETA SMS в очереди → {phone}',
    customerEtaSmsSkipped: 'ETA SMS пропущено (opt-out: {phone})',
  ...
  settings: {
    ...
    auditCheckLabels: {
      ...
      analytics_field_jobs_lightweight_audit: 'Лёгкие запросы аналитики и полевых jobs',
    },
    auditActions: {
    ...
    notificationHubSkipReasonEmail: 'Клиент отключил email-уведомления',
    notificationHubSkipReasonSms: 'Клиент отключил SMS-уведомления',
    ...
    notificationStatusSkipped: 'Пропущено',
