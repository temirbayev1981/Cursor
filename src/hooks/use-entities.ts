...
import { listEntities, saveEntity, deleteEntity, createJobFromVendorPO, createEstimateFromJob, createInvoiceFromEstimate, createScheduleFromJob, importSampleData, listFuelLogs, getFuelLogsSummary, getExpensesSummary, getInvoicesSummary, getMaterialsSummary, listCustomerContacts, listCustomerReportSummaries, getEstimatesPendingSummary, getSmartEngineJobContext, saveFuelLog, listAuditLogs, logAudit, type CustomerContact } from '@/services/entity-service'
