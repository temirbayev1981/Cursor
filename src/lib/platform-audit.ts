...
import { AUDIT_E2E_FULL_COVERAGE, AUDIT_I18N_COVERAGE, BILLING_PLAN_AUDIT, BULK_OPS_AUDIT, COMPANY_PROFILE_AUDIT, COMPANY_SWITCH_AUDIT, DISPATCH_AUDIT, ENTITY_UPDATE_AUDIT, ESTIMATE_CREATE_AUDIT, EXPENSE_AUDIT, FLEET_AUDIT, FUEL_LOG_AUDIT, INTEGRATION_PROBES_AUDIT, INTEGRATION_PROBE_HISTORY_AUDIT, INTEGRATION_PROBE_UI_AUDIT, INVOICE_AUDIT, INVITE_AUDIT, NOTIFICATION_HUB_AUDIT, NOTIFICATION_OPT_OUT_AUDIT, NOTIFY_SKIPPED_TOAST_AUDIT, OBSERVABILITY_PROBE_AUDIT, PORTAL_AUDIT, PORTAL_NOTIFICATION_PREFS_AUDIT, PORTAL_REQUESTS_AUDIT, PWA_SW_OFFLINE_AUDIT, SAMPLE_IMPORT_AUDIT, STAFF_CUSTOMER_NOTIFY_AUDIT, TEAM_INVITE_AUDIT, VENDOR_PO_AUDIT } from '@/lib/audit-labels'
