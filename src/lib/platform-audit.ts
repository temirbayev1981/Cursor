...
import { AUDIT_E2E_FULL_COVERAGE, AUDIT_I18N_COVERAGE, AI_ASSISTANT_LIGHTWEIGHT_AUDIT, ANALYTICS_FIELD_JOBS_LIGHTWEIGHT_AUDIT, BILLING_PLAN_AUDIT, BULK_OPS_AUDIT, COMPANY_PROFILE_AUDIT, COMPANY_SWITCH_AUDIT, CUSTOMER_CONTACTS_AUDIT, CUSTOMER_SMS_OPT_OUT_AUDIT, DASHBOARD_REPORTS_LIGHTWEIGHT_AUDIT, DISPATCH_AUDIT, DISPATCH_ETA_SMS_AUDIT, ENTITY_UPDATE_AUDIT, ESTIMATE_CREATE_AUDIT, ESTIMATE_INVOICE_SMS_AUDIT, ESTIMATES_LIGHTWEIGHT_AUDIT, EXPENSE_AUDIT, FIELD_OPS_MILESTONE_AUDIT, FLEET_AUDIT, FUEL_LOG_AUDIT, INTEGRATION_PROBES_AUDIT, INTEGRATION_PROBE_HISTORY_AUDIT, INTEGRATION_PROBE_UI_AUDIT, INVOICE_AUDIT, INVITE_AUDIT, KPI_SUMMARY_AUDIT, NOTIFICATION_HUB_AUDIT, NOTIFICATION_HUB_DISPATCH_EMAIL_SKIP_AUDIT, NOTIFICATION_HUB_EMAIL_SKIP_CSV_AUDIT, NOTIFICATION_HUB_ETA_EMAIL_SKIP_AUDIT, NOTIFICATION_HUB_ETA_SMS_SKIP_AUDIT, NOTIFICATION_HUB_ESTIMATE_INVOICE_SMS_SKIP_AUDIT, NOTIFICATION_HUB_INVOICE_EMAIL_SKIP_AUDIT, NOTIFICATION_HUB_SCHEDULING_EMAIL_SKIP_AUDIT, NOTIFICATION_HUB_SCHEDULING_SMS_SKIP_AUDIT, NOTIFICATION_HUB_SKIP_CHANNEL_FILTER_AUDIT, NOTIFICATION_HUB_SKIP_LOG_AUDIT, NOTIFICATION_HUB_SKIP_OPS_AUDIT, NOTIFICATION_HUB_SKIP_SUMMARY_AUDIT, NOTIFICATION_HUB_SMS_SKIP_CSV_AUDIT, NOTIFICATION_MILESTONE_AUDIT, NOTIFICATION_OPT_OUT_AUDIT, NOTIFY_SKIPPED_TOAST_AUDIT, OBSERVABILITY_PROBE_AUDIT, PORTAL_AUDIT, PORTAL_EMAIL_OPT_OUT_BADGE_AUDIT, PORTAL_NOTIFICATION_PREFS_AUDIT, PORTAL_REQUESTS_AUDIT, PORTAL_SMS_NOTIFY_SYNC_AUDIT, PORTAL_SMS_OPT_OUT_BADGE_AUDIT, PORTAL_STAFF_NOTIFY_SYNC_AUDIT, PWA_SW_OFFLINE_AUDIT, SAMPLE_IMPORT_AUDIT, SCHEDULING_CUSTOMER_SMS_AUDIT, SCHEDULING_DISPATCH_LIGHTWEIGHT_AUDIT, SERVER_PAGINATION_AUDIT, STAFF_CUSTOMER_NOTIFY_AUDIT, STAFF_CUSTOMER_SMS_BADGE_AUDIT, TEAM_INVITE_AUDIT, TECH_OFFLINE_SYNC_AUDIT, VENDOR_PO_AUDIT } from '@/lib/audit-labels'
...
export function computePlatformAudit(options: PlatformHealthOptions = {}): PlatformAuditReport {
  ...
  const qualityChecks: PlatformAuditCheck[] = [
    ...
    { id: 'tech_offline_sync_audit', label: 'Technician offline sync E2E', ok: liveBackend && TECH_OFFLINE_SYNC_AUDIT, weight: 0.5 },
    { id: 'field_ops_milestone_audit', label: 'Field-ops milestone complete', ok: liveBackend && FIELD_OPS_MILESTONE_AUDIT, weight: 0.5 },
    ...
    { id: 'estimate_invoice_sms_audit', label: 'Estimate & invoice SMS opt-out', ok: liveBackend && ESTIMATE_INVOICE_SMS_AUDIT, weight: 0.5 },
    { id: 'dispatch_eta_sms_audit', label: 'Dispatch ETA SMS E2E', ok: liveBackend && DISPATCH_ETA_SMS_AUDIT, weight: 0.5 },
    { id: 'portal_sms_notify_sync_audit', label: 'Portal SMS notify sync', ok: liveBackend && PORTAL_SMS_NOTIFY_SYNC_AUDIT, weight: 0.5 },
    { id: 'notification_hub_estimate_invoice_sms_skip_audit', label: 'Hub estimate/invoice SMS skip', ok: liveBackend && NOTIFICATION_HUB_ESTIMATE_INVOICE_SMS_SKIP_AUDIT, weight: 0.5 },
    { id: 'staff_customer_sms_badge_audit', label: 'Staff CRM SMS opt-out badge', ok: liveBackend && STAFF_CUSTOMER_SMS_BADGE_AUDIT, weight: 0.5 },
    { id: 'notification_hub_eta_sms_skip_audit', label: 'Hub dispatch ETA SMS skip', ok: liveBackend && NOTIFICATION_HUB_ETA_SMS_SKIP_AUDIT, weight: 0.5 },
    { id: 'portal_sms_opt_out_badge_audit', label: 'Portal SMS opt-out badge', ok: liveBackend && PORTAL_SMS_OPT_OUT_BADGE_AUDIT, weight: 0.5 },
    { id: 'notification_hub_scheduling_sms_skip_audit', label: 'Hub scheduling SMS skip', ok: liveBackend && NOTIFICATION_HUB_SCHEDULING_SMS_SKIP_AUDIT, weight: 0.5 },
    { id: 'portal_email_opt_out_badge_audit', label: 'Portal email opt-out badge sync', ok: liveBackend && PORTAL_EMAIL_OPT_OUT_BADGE_AUDIT, weight: 0.5 },
    { id: 'notification_hub_sms_skip_csv_audit', label: 'Hub SMS skip CSV export', ok: liveBackend && NOTIFICATION_HUB_SMS_SKIP_CSV_AUDIT, weight: 0.5 },
    { id: 'notification_hub_skip_summary_audit', label: 'Hub skip summary breakdown', ok: liveBackend && NOTIFICATION_HUB_SKIP_SUMMARY_AUDIT, weight: 0.5 },
    { id: 'notification_hub_dispatch_email_skip_audit', label: 'Hub dispatch email skip', ok: liveBackend && NOTIFICATION_HUB_DISPATCH_EMAIL_SKIP_AUDIT, weight: 0.5 },
    { id: 'notification_hub_scheduling_email_skip_audit', label: 'Hub scheduling email skip', ok: liveBackend && NOTIFICATION_HUB_SCHEDULING_EMAIL_SKIP_AUDIT, weight: 0.5 },
    { id: 'notification_hub_eta_email_skip_audit', label: 'Hub dispatch ETA email skip', ok: liveBackend && NOTIFICATION_HUB_ETA_EMAIL_SKIP_AUDIT, weight: 0.5 },
    { id: 'notification_hub_invoice_email_skip_audit', label: 'Hub invoice email skip', ok: liveBackend && NOTIFICATION_HUB_INVOICE_EMAIL_SKIP_AUDIT, weight: 0.5 },
    { id: 'notification_milestone_audit', label: 'Notification milestone complete', ok: liveBackend && NOTIFICATION_MILESTONE_AUDIT, weight: 0.5 },
    { id: 'notification_hub_skip_channel_filter_audit', label: 'Hub skip channel filter', ok: liveBackend && NOTIFICATION_HUB_SKIP_CHANNEL_FILTER_AUDIT, weight: 0.5 },
    { id: 'notification_hub_email_skip_csv_audit', label: 'Hub email skip CSV export', ok: liveBackend && NOTIFICATION_HUB_EMAIL_SKIP_CSV_AUDIT, weight: 0.5 },
    ...
    { id: 'server_pagination_audit', label: 'Server-side table pagination', ok: liveBackend && SERVER_PAGINATION_AUDIT, weight: 0.5 },
    { id: 'kpi_summary_audit', label: 'Lightweight KPI summaries', ok: liveBackend && KPI_SUMMARY_AUDIT, weight: 0.5 },
    { id: 'estimates_lightweight_audit', label: 'Estimates lightweight context', ok: liveBackend && ESTIMATES_LIGHTWEIGHT_AUDIT, weight: 0.5 },
    { id: 'customer_contacts_audit', label: 'Customer contact lookups', ok: liveBackend && CUSTOMER_CONTACTS_AUDIT, weight: 0.5 },
    { id: 'dashboard_reports_lightweight_audit', label: 'Dashboard/reports lightweight queries', ok: liveBackend && DASHBOARD_REPORTS_LIGHTWEIGHT_AUDIT, weight: 0.5 },
    { id: 'ai_assistant_lightweight_audit', label: 'AI assistant lightweight context', ok: liveBackend && AI_ASSISTANT_LIGHTWEIGHT_AUDIT, weight: 0.5 },
    { id: 'scheduling_dispatch_lightweight_audit', label: 'Scheduling/dispatch lightweight jobs', ok: liveBackend && SCHEDULING_DISPATCH_LIGHTWEIGHT_AUDIT, weight: 0.5 },
    { id: 'analytics_field_jobs_lightweight_audit', label: 'Analytics/field lightweight jobs', ok: liveBackend && ANALYTICS_FIELD_JOBS_LIGHTWEIGHT_AUDIT, weight: 0.5 },
  ]
