...
import { AUDIT_E2E_FULL_COVERAGE, AUDIT_I18N_COVERAGE, BILLING_PLAN_AUDIT, BULK_OPS_AUDIT, COMPANY_PROFILE_AUDIT, COMPANY_SWITCH_AUDIT, CUSTOMER_SMS_OPT_OUT_AUDIT, DISPATCH_AUDIT, DISPATCH_ETA_SMS_AUDIT, ENTITY_UPDATE_AUDIT, ESTIMATE_CREATE_AUDIT, ESTIMATE_INVOICE_SMS_AUDIT, EXPENSE_AUDIT, FLEET_AUDIT, FUEL_LOG_AUDIT, INTEGRATION_PROBES_AUDIT, INTEGRATION_PROBE_HISTORY_AUDIT, INTEGRATION_PROBE_UI_AUDIT, INVOICE_AUDIT, INVITE_AUDIT, NOTIFICATION_HUB_AUDIT, NOTIFICATION_HUB_ETA_SMS_SKIP_AUDIT, NOTIFICATION_HUB_ESTIMATE_INVOICE_SMS_SKIP_AUDIT, NOTIFICATION_HUB_SCHEDULING_SMS_SKIP_AUDIT, NOTIFICATION_HUB_SKIP_LOG_AUDIT, NOTIFICATION_HUB_SKIP_OPS_AUDIT, NOTIFICATION_HUB_SMS_SKIP_CSV_AUDIT, NOTIFICATION_OPT_OUT_AUDIT, NOTIFY_SKIPPED_TOAST_AUDIT, OBSERVABILITY_PROBE_AUDIT, PORTAL_AUDIT, PORTAL_EMAIL_OPT_OUT_BADGE_AUDIT, PORTAL_NOTIFICATION_PREFS_AUDIT, PORTAL_REQUESTS_AUDIT, PORTAL_SMS_NOTIFY_SYNC_AUDIT, PORTAL_SMS_OPT_OUT_BADGE_AUDIT, PORTAL_STAFF_NOTIFY_SYNC_AUDIT, PWA_SW_OFFLINE_AUDIT, SAMPLE_IMPORT_AUDIT, SCHEDULING_CUSTOMER_SMS_AUDIT, STAFF_CUSTOMER_NOTIFY_AUDIT, STAFF_CUSTOMER_SMS_BADGE_AUDIT, TEAM_INVITE_AUDIT, VENDOR_PO_AUDIT } from '@/lib/audit-labels'
