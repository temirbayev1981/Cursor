...
describe('audit-labels', () => {
  ...
  it('recognizes v1.12.0 field-ops milestone gates', () => {
    expect(TECH_OFFLINE_SYNC_AUDIT).toBe(true)
    expect(FIELD_OPS_MILESTONE_AUDIT).toBe(true)
  })
  ...
  it('recognizes v1.10.8 customer SMS opt-out gate', () => {
    ...
    expect(NOTIFICATION_HUB_EMAIL_SKIP_CSV_AUDIT).toBe(true)
  })
