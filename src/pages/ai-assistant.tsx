...
import { useAiBusinessContext } from '@/hooks/use-entities'
...
export default function AIAssistantPage() {
  ...
  const { data: stats } = useAiBusinessContext()
  const businessContext = buildBusinessContext(stats ?? EMPTY_AI_BUSINESS_CONTEXT, locale)
