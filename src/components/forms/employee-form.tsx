...
export function EmployeeForm({ companyId, onSubmit, onCancel }: EmployeeFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit(submit)} className="space-y-4" data-testid="employee-form">
      ...
      <div className="flex justify-end gap-2 pt-2">
        ...
        <Button type="submit" disabled={isSubmitting} data-testid="employee-form-submit">{t.common.save}</Button>
      </div>
    </form>
  )
}
