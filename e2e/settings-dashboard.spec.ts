...
test.describe('Settings billing & team', () => {
  ...
  test('system tab shows platform audit checklist and coverage summary', async ({ page }) => {
    ...
    await expect(page.getByTestId('platform-audit-check-company_profile_audit')).toBeVisible()
    await expect(page.getByTestId('platform-audit-check-portal_audit')).toBeVisible()
    await expect(page.getByTestId('platform-audit-check-company_switch_audit')).toBeVisible()
    await expect(page.getByTestId('platform-audit-check-invite_audit')).toBeVisible()
    await expect(page.getByTestId('platform-audit-check-bulk_ops_audit')).toBeVisible()
    await expect(page.getByTestId('platform-audit-check-billing_plan_audit')).toBeVisible()
    await expect(page.getByTestId('platform-audit-check-team_invite_audit')).toBeVisible()
    await expect(page.getByTestId('platform-audit-check-invoice_audit')).toBeVisible()
    await expect(page.getByTestId('platform-audit-check-sample_import_audit')).toBeVisible()
    await expect(page.getByTestId('platform-audit-check-portal_requests_audit')).toBeVisible()
    await expect(page.getByTestId('platform-audit-check-estimate_create_audit')).toBeVisible()
    await expect(page.getByTestId('platform-audit-check-entity_update_audit')).toBeVisible()
    ...
    await expect(page.getByTestId('platform-audit-check-customer_contacts_audit')).toBeVisible()
    await expect(page.getByTestId('platform-audit-check-dashboard_reports_lightweight_audit')).toBeVisible()
    await expect(page.getByTestId('platform-audit-check-ai_assistant_lightweight_audit')).toBeVisible()
    await expect(page.getByTestId('platform-audit-check-scheduling_dispatch_lightweight_audit')).toBeVisible()
    await expect(page.getByTestId('platform-audit-check-analytics_field_jobs_lightweight_audit')).toBeVisible()
